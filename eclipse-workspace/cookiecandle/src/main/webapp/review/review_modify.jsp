...
<div style="margin-top: 100px;">
	<div class="board_title_div" align="center">
		<h4 class="board_title">review_modify</h4>
		<div class="board_under"></div>
	</div>
	<br>
	<form action="index.jsp?workgroup=review&work=review_modify_action" method="post" id="reviewForm">
		<input type="hidden" name="rNo" value="<%=reviewView.getrNo()%>">
		<table class="board_view_table">
  		<tbody>
  			<tr>
  				<th>PRODUCT</th>
  				<td colspan="3">
  					<select id="product" name="product" class="form-select form-select-sm" aria-label=".form-select-sm example">
		    ...
		    <tr>
			    ...
			    <td colspan="3">
			    	<div class="form-floating">
  						<input type="text" name="rTitle" value="<%=reviewView.getrTitle() %>">
					</div>
				<td>
		    </tr>
		    <tr>
			    ...
			    <td colspan="3">
			    	<div class="form-floating">
  						<textarea class="form-control" name="rContent" style="height: 100px"><%=reviewView.getrContent() %></textarea>
					</div>
				<td>
		    </tr>
  		</tbody>
...
$("#product").val("<%=reviewView.getpNum()%>")
</script>