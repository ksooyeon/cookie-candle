...
<%	
	...
	String ref="0", reStep="0", pageNum="1";
...
<div style="margin-top: 100px;">
	...
	<br>
	<form action="index.jsp?workgroup=question&work=question_write_action" method="post" id="questionForm">
		<input type="hidden" name="qUid" value="<%=userLogin.getUid()%>">
		...
		<table class="board_view_table">
  			<tbody>
		    	...
		    	<tr>
			    	...
			    	<td colspan="3">
			    		<div class="form-floating">
  							<textarea class="form-control" id="qContent" name="qContent" style="height: 100px"></textarea>
						</div>
					<td>
		    	</tr>
  			</tbody>
