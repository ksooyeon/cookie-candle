...
<div style="margin-top: 100px;">
	<div class="board_title_div" align="center">
		<h4 class="board_title">question_modify</h4>
		<div class="board_under"></div>
	</div>
	<br>
	<form action="index.jsp?workgroup=question&work=question_modify_action" method="post" id="questionForm">
		<input type="hidden" name="qNo" value="<%=questionView.getqNo()%>">
		    ...
		    <tr>
			    ...
			    <td colspan="3">
			    	<div class="form-floating">
  						<input type="text" name="qTitle" value="<%=questionView.getqTitle()%>">
					</div>
				<td>
		    </tr>
		    <tr>
			    ...
			    <td colspan="3">
			    	<div class="form-floating">
  						<textarea class="form-control" name="qContent" style="height: 100px"><%=questionView.getqContent() %></textarea>
					</div>
				<td>
		    </tr>
  		</tbody>
